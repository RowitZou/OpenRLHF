...
rm_name="RM_PTSFTinternal"

# === Paths ===
actor_pretrain_path="/cpfs01/shared/alillm_hs/liushichun1/models/internlm3-8b-instruct-wo-rl"
reward_pretrain_path="/cpfs01/shared/alillm_hs/zouyicheng/rm_pretrain/rm/RM_SFT_reward_pt_1_8b_final_DATA_puyu_standard_Node_2_LR_1e-5_STEP_247_hf"
