...
prompt_data_path=/cpfs01/shared/llm_ddd/zouyicheng/rm_pretrain/data/ppo/puyu-rl/train_qwen
total_sample_num=173426

name="ppo-ray-policy_${policy_model_name}-${rm_name}_data_${data_type}_bsz_${rollout_batch_size}_lr_1e-6"
